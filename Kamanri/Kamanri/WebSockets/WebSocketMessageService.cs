...
namespace Kamanri.WebSockets
{
    ...
    public sealed class WebSocketMessageService
    {
        ...
        public void AddEventHandler(WebSocketMessageEvent messageEvent, Func<WebSocket, IList<WebSocketMessage>, Task<IList<WebSocketMessage>>> EventHandler)
        {
            ...
            {
                _logger.LogError($"Add Event {messageEvent.Code} Failure : A Event Has Existed Or Have The Same Code With Your Event");
                return;
            }
        ...
        public async Task<IList<WebSocketMessage>> OnMessage(WebSocket webSocket, IList<WebSocketMessage> messages)
        {
            ...
            _logger.LogInformation($"Received Message Event Code : {firstMessage.MessageEvent.Code}, Try To Find And Execute The Corresponding Handler");
            ...
            {
                _logger.LogError($"The Corresponding Handler Of {firstMessage.MessageEvent.Code} Is Not Found, It Will Cause Exception");
