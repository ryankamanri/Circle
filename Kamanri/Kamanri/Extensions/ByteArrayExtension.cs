...
namespace Kamanri.Extensions
{
    public static class ByteArrayExtension
    {
        ...
        public static string ToStringContent(this byte[] bytes)
        {
            ...
            {
                throw new Exception($"Failed To Convert The ByteArray To String : \n {bytes.ShowArrayItems(0x20)} \n Caused By : ", e);
            }
        ...
        /// <returns></returns>
        public static string ShowArrayItems(this byte[] bytes, int maxCount = 0xffff)
        {
            string result = "";
        ...
        public static int GetAWebSocketMessage(this byte[] bytes, IList<WebSocketMessage> wsMessages, int startIndex = 0)
        {
            ...
            {
                throw new Exception($"Failed To Get WebSocketMessage From Bytes : \n {bytes.ShowArrayItems()} \n Caused By : ");
            }
        ...
        public static void GetWebSocketMessages(this byte[] bytes, IList<WebSocketMessage> wsMessages, int startIndex = 0)
        {
            ...
            {
                throw new Exception("Failed To Get WebSocketMessages \n Caused By : ", e);
            }
        }
