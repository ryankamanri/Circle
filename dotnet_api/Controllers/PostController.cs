...
namespace dotnetApi.Controller
{
    ...
    public class PostController : ControllerBase
    {
        ...
        {
            Post post = (Post)JsonConvert.DeserializeObject(HttpContext.Request.Form["Post"]);
        ...
        public async Task<IActionResult> InsertPost()
        {
            ...
            await _postService.InsertPost(
                (User)JsonConvert.DeserializeObject(Author),
                Title,Focus,Summary,Content,TagIDs);
